<script lang="ts">
    ...
    // This receives a list of planners (as elements) and a header as props from the caller.
...
<div>
    <!-- This toggles the list of planners from the users' view -->
    <button 
